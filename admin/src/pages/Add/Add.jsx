    ...
    <div className='add'>
        <form className='flex-col' onSubmit={onFormSubmitHandler}>
            <div className="add-img-upload flex-col">
                <p>Upload Image</p>
                <label htmlFor="food-img">
                    <img src={image?URL.createObjectURL(image):assets.upload} alt="" />
                    <br/>
                </label>
                <input onChange={(e)=>setImage(e.target.files[0])} type="file" id='food-img' hidden required />
            </div>
            ...
            <div className='add-product-description flex-col'>
                ...
                <textarea onChange={onChangeHandler} value={data.description} placeholder='Description goes here' name='description' required></textarea>
            </div>
